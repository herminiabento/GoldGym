...
<section class="py-3 py-lg-5">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form novalidate method="POST" action="{{route('user.membership.store')}}">
                @csrf
                <div class="row mb-5">
                            ...
                            <div class="col-md-4 py-2 mb-3">
                                <div class="form-check">
                                    <input
                                        ...
                                        {{ in_array($plan->id, old('plans', [])) ? 'checked' : '' }}
                                    />
                                    ...
                                    <label class="form-check-label" for="plan_{{ $plan->id }}">
                                        ...
                                        / <span class="text-muted small fst-italic">{{ $plan->duration }}</span>
                                        </span>
                                    </label>
